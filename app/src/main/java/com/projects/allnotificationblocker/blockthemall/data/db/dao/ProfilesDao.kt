...
interface ProfilesDao {
    @Insert suspend fun insert(record: Profile)

    @Update suspend fun update(record: Profile)

    @Delete suspend fun delete(record: Profile)

    @Query("DELETE FROM profiles_table") suspend fun deleteAllProfiles()
